        ...
        <td>
          {data.report_task.map((image, i) => {
            return (
              <img
                key={i}
                src={`https://backend.omcloud.vn/uploads/` + image.photo}
                width="150px"
                style={{ padding: "8px" }}
              />
            );
...
export default function ExportReport() {
  ...
  const loadConstruction = async () => {
    const result = await axios.get(
      "https://backend.omcloud.vn/api/construction?status=3",
    );
                  ...
                  <div className="col medium-6 small-12 large-6">
                    <div className={classes.newConstructionItem}>
                      ...
                      <input
                        ...
                        placeholder={t("title-name-enter")}
                      />
                    </div>
                  </div>
                  <div className="col medium-6 small-12 large-6">
                ...
                <div className="row">
                  <div className="col medium-6 small-12 large-6">
                    <div className={classes.newConstructionItem}>
                      ...
                      >
                        <option>--------</option>
                        {Construction.map((name, key) => (
                          <option key={key.id} value={name.id}>
                            {name.name}
                          </option>
                        ))}
                      </select>
                  ...
                  <div className="col medium-6 small-12 large-6">
                    <div className={classes.newConstructionItem}>
                      ...
                      <input
                        ...
                        placeholder={t("dateIssued-enter")}
                      />
                    </div>
                  </div>
                </div>
                  ...
                  <div className="col medium-4 small-12 large-4">
                    <div className={classes.newConstructionItem}>
                      ...
                      <input
                        ...
                        placeholder={t("timeIssued-enter")}
                      />
                    </div>
                  </div>
                  <div className="col medium-4 small-12 large-4">
                    <div className={classes.newConstructionItem}>
                      ...
                      <input
                        ...
                        placeholder={t("clientName-enter")}
                      />
                    </div>
                  </div>
                  <div className="col medium-4 small-12 large-4">
                  ...
                  <div className="col medium-6 small-12 large-6">
                    <div className={classes.newConstructionItem}>
                      ...
                      <textarea
                        ...
                        placeholder={t("hiconReviews-enter")}
                      ></textarea>
                    </div>
                  </div>
                  <div className="col medium-6 small-12 large-6">
                    <div className={classes.newConstructionItem}>
                      ...
                      <textarea
                        ...
                        placeholder={t("customerReviews-enter")}
                      ></textarea>
                    </div>
                  </div>
                </div>
